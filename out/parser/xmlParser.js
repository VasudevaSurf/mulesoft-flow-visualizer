...
class MuleXmlParser {
    ...
    static doParse(xmlContent) {
        ...
        parser.on('opentag', (tag) => {
            ...
            const currentNs = Object.assign({}, nsStack[nsStack.length - 1]);
            const attributes = {};
...
MuleXmlParser.lastGoodResult = null;
