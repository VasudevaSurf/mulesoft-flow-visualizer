...
exports.CORE_ICONS = void 0;
exports.generateSvgSymbols = generateSvgSymbols;
exports.CORE_ICONS = {
...
function generateSvgSymbols() {
    return Object.entries(exports.CORE_ICONS)
        .map(([id, svg]) => {
        const inner = svg
            .replace(/<svg[^>]*>/, "")
            .replace(/<\/svg>/, "");
...
//# sourceMappingURL=coreIcons.js.map